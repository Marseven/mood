...
class HomeController extends Controller {
        ...
        if ($val = $this->request->input('val')) {
            ...
            if ($validator->passes()) {
                ...
                foreach ($audioFiles as $audio) {
                    ...
                    $newVal['release_date'] =$newVal['release'];
    ...
    public function welcomeLoad() {
        $users = $this->model('user')->getPeople('top', '', 20, 0, array(
    ...
    public function authFacebook() {
        ...
        if(empty($code)) {
            ...
            $dialog_url = "https://www.facebook.com/dialog/oauth?client_id=".$app_id."&redirect_uri=".urlencode($my_url)."&scope=email&state=".$_SESSION['state'];
